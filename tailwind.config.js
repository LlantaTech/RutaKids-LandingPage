  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'secondary-800': '#2979FF',
        'secondary-900': '#F7F7FF',
        //
        //'secondary-100': '#2979FF',
        //'secondary-200': '#2979FF',
        //'secondary-300': '#2979FF',
        //'secondary-400': '#2979FF',
        //'secondary-500': '#2979FF',
        //'secondary-600': '#2979FF',
        //'secondary-700': '#2979FF',
        'accent-400': '#0E0E0C',
        'accent-300': '#262626',
        'accent-200': '#4D4D4D',
        'accent-100': '#666666',
